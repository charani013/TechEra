...
import TecheraDetails from '../TecheraDetails'
...
class TecheraCourseDetails extends Component {
  state = {
    CourseDetailsList: [],
      ...
      <div className="tech-era-course-container">
        <ul className="ul-class">
          {CourseDetailsList.map(each => (
            <TecheraDetails key={each.id} courseItemDetails={each} />
          ))}
        </ul>
      </div>
    )
...
export default TecheraCourseDetails
